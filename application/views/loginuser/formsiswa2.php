...
<head>
    ...
    <link href="<?php echo base_url()."assets/css/bootstrap.min.css"?>" rel="stylesheet" type="text/css"> <!-- UDAH BENER -->
	<!--login neon-->
									...
									<div class="panel-body">
										<form role="form" id="form1" method="post" class="validate" action="<?php echo site_url('datasiswa'); ?>/save">
											...
											<div class="form-group" align="center">
												...
												<input type="file" name="<?php echo form_upload('pic'); ?>" data-validate="berkas Siswa" data-message-required="Harus Diisi !!."/>
											</div>
