        ...
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo base_url();?>/assets/img/emtext.png" alt="" />
                </a>
            </div>
					...
					<div class="team boxed-grey">
						<div class="inner">
							<div class="row">
								<h5>Edu Modu</h5>
								<div class="col-md-4">
									<div class="avatar" style="position:center"><img src=<?php echo base_url()."assets/img/emicon.png"?> alt="" class="img-responsive img-circle" /></div>
								</div>
								<div class="col-md-8">
									<p class="subtitle">Edu Modu adalah sebuah lembaga bimbingan belajar bagi siswa SD hingga SMA yang diinisiasi oleh beberapa mahasiswa ITS sejak awal 2017. Tenaga pengajar berasal dari mahasiswa seluruh universitas di Surabaya yang telah diseleksi dan dilatih untuk memenuhi kualifikasi sebagai tentor. Program yang kami tawarkan bukan hanya mata pelajaran sekolah namun juga materi persiapan olimpiade seperti OSN, Olimpiade Sains, dsb. Siswa dapat memilih jadwal belajar sesuai kebutuhan dan tentor akan berkunjung ke rumah siswa.</p>
								</div>
							</div>
						</div>
					</div>
