		...
		<div class="container">
			...
			<div class="panel-heading">
							<div class="panel-title">
								Form Pendaftaran Tentor Edu Modu
							</div>
				...
				<div class="panel-body">
							<form role="form" enctype="multipart/form-data" class="form-horizontal form-groups-bordered" method="post" action="<?php echo site_url('D_Peserta'); ?>/addpeserta">
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Nama Tentor</label>
								
									<div class="col-sm-5">
										<input type="text" class="form-control" name="nama_tentor" id="field-1" placeholder="Nama Peserta">
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Pendidikan Terakhir</label>
								
									<div class="col-sm-5">
										<input type="text" class="form-control" name="pendidikan_tentor" id="field-1" placeholder="Nama Peserta">
									</div>
								</div>
								<div class="form-group">
									<label for="field-ta" class="col-sm-3 control-label">Alamat Lengkap Tentor</label>
			
									<div class="col-sm-5">
										<textarea class="form-control autogrow" name="alamat_tentor" id="field-ta" placeholder="Alamat Lengkap Peserta"></textarea>
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Telp/No.HP Tentor</label>
								
									<div class="col-sm-5">
										<input type="text" class="form-control" name="kontak_tentor" id="field-1" placeholder="Kontak Peserta">
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Email Tentor</label>
								
									<div class="col-sm-5">
										<input type="email" class="form-control" name="email_tentor" id="field-1" placeholder="Email Peserta">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Upload CV (jpg/jpeg/png)</label>
									
									<div class="col-sm-5">
										
										<input type="file" class="form-control" name="tentorfile"/>
